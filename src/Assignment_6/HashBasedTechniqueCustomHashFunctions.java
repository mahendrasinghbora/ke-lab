...
public class HashBasedTechniqueCustomHashFunctions {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Hash Based Technique for Improving the Efficiency" +
                " of Apriori (Custom Hash Functions)");
        System.out.println("=".repeat(100));
        ...
        System.out.println("-".repeat(100));
        System.out.println("Hash Function for 2 - Length Item Sets: (2 * x +" +
                " y) % 5");
        System.out.println("Hash Function for 3 - Length Item Sets: (7 * x +" +
                " 5 * y + z) % 5");
        System.out.println("-".repeat(100));
