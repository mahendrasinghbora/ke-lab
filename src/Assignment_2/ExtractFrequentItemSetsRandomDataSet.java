...
public class ExtractFrequentItemSetsRandomDataSet {
    ...
    public static void main(String[] args) {
        ...
        try (BufferedReader fileIn = new BufferedReader(new FileReader(
            ...
            int minimumSupport = (int) Math.ceil(0.3 * numberOfTransactions);

            System.out.println("Items = " + itemList);
            System.out.println("Number of Transactions = " + numberOfTransactions);
            System.out.println("Minimum Support Count = (30% of " + numberOfTransactions + ") = " +
                    minimumSupport);
            System.out.println("-".repeat(60));
